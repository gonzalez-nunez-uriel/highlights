...
namespace Highlights.Migrations
{
    ...
    [Migration("20221228144938_CreateManyToManyTagHighlight")]
    partial class CreateManyToManyTagHighlight
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HighlightTag", b =>
                {
                    b.HasOne("Highlights.Models.Highlight", null)
                        .WithMany()
                        .HasForeignKey("HighlightsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Highlights.Models.Tag", null)
                        .WithMany()
